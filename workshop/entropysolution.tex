...
\begin{equation}\label{eq:parabolicsystemofconservationlaw}
	...
	\diffp*{\symbf{f}\left(\symbf{u}_{\varepsilon}\right)}{x}-
	\varepsilon
...
\subsection{Sistema de leyes de conservación lineal}
