...
\begin{frame}
	...
	\begin{figure}[ht!]
		...
		\caption{Single critical point and $f$ is a concave function.}
	\end{figure}
\end{frame}
	...
	\begin{proof}
		...
		\begin{align*}
			...
			\begin{cases}
				...
				0<\varepsilon-2\theta_{0}+\sqrt{\Delta}
				\iff
				\theta^{\text{crit}}_{+}<0.                          \\
				                                       & \quad\wedge \\
				\varepsilon-2\theta_{0}<\sqrt{\Delta}  & \iff
...
\begin{frame}
	...
	\begin{figure}[ht!]
		\centering
		\includegraphics[width=.43\paperwidth]{example-image}
		\caption{.}
	\end{figure}
\end{frame}
