...
% TODO: Antes de la curva Gamma, colocar la EDO.

\subsubsection{The curve $\Gamma$}
% TODO: Agregar ima introducción a la curva Gamma, reescribiendo la EDO original Sy' y theta'. Usan f(theta) reescribiendo, se observa que para determinar el diagrama de fase es necesario conocer el comportamiento de f(theta)
% Consideramos q>0 se obtiene el siguiente diagrama de fase. y se observa fuente y silla.
\begin{equation*}
