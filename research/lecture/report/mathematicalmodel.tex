...
\begin{equation}
	...
	\rho_o Q_r Y S_\text{g} S_{\text{o}}  W_{\text{r}}
	\textcolor{red}{-\alpha\left(T-T_{\text{res}}\right)}.
	\label{Ec1a}
\end{equation}
\begin{equation}
	\varphi
	\partial_{t}(Y S_\text{g}\rho_g)+
	\partial_x (Y S_\text{g} \rho_g u_g)=
	-w\varphi\rho_o Y S_\text{g} S_{\text{o}}  W_{\text{r}}.
	\label{Ec2a}
\end{equation}
\begin{equation}
	\varphi
	...
	\partial_{x}
	(\rho_o  S_{\text{o}}  u_o)=
	-\varphi\rho_{o} Y S_\text{g} S_{\text{o}} W_{\text{r}}.
	\label{Ec3a}
\end{equation}
...
Following \cite{traveling,gargar2020combustion}, the reaction rate $W_{\text{r}}$ is given by Arrhenius law:
\begin{equation}
	W_{\text{r}} = k_{p}\exp \Big(-\frac{E_\text{r}}{RT}\Big),
	\label{Ec4a}
\end{equation}
...
\end{equation}
% TODO: Citar a rosmery y explicar OC y FC
