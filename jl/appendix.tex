...
\begin{listing}[ht!]
	\tiny
	\centering
	\inputminted[frame=single,framesep=10pt,firstline=1,lastline=52,linenos]{python}{figura21.py}
...
\begin{listing}[ht!]
	\tiny
	\centering
	\inputminted[frame=single,framesep=10pt,linenos]{python}{tabla51.py}
...
\begin{listing}[ht!]
	\tiny
	\centering
	\inputminted[frame=single,framesep=10pt,linenos]{python}{johnson.py}
